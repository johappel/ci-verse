            ...
            if (!empty($stand['rss_feeds'])) {
                ...
                return [
                    ...
                    'display' => [
                        ...
                        'bannerImage' => civerse_to_relative_url($stand['banner_image'] ?? ''),
                    ],
                    'chatWebhook' => !empty($stand['chat_webhook']) ? $stand['chat_webhook'] : null,
                    'chatbotLabel' => !empty($stand['chatbot_label']) ? $stand['chatbot_label'] : 'Frag mich!',
                    'chatWelcomeMessage' => !empty($stand['chat_welcome_message']) ? $stand['chat_welcome_message'] : null,
